...
"""
This custom extension should be exactly the same as https://github.com/Python-Markdown/markdown/blob/master/markdown/extensions/toc.py except for small differences in the slugify function.

These changes are necessary to make a header like # wifi 2.4 be sluggified to wifi-2-4 instead of the default wifi-24. 
(Obsidian uses the prior method and this causes issues).

See for more information: https://github.com/obsidian-html/obsidian-html/issues/303
...
class CustomTocExtension(Extension):
    ...
    def __init__(self, **kwargs):
        self.config = {
            ...
            "anchorlink_class": ["toclink", "CSS class(es) used for the link. " 'Defaults to "toclink"'],
            "permalink": [0, "True or link text if a Sphinx-style permalink should " "be added - Defaults to False"],
            "permalink_class": ["headerlink", "CSS class(es) used for the link. " 'Defaults to "headerlink"'],
            "permalink_title": ["Permanent link", "Title attribute of the permalink - " "Defaults to 'Permanent link'"],
